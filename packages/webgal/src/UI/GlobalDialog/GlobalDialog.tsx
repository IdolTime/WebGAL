      ...
      <div className={styles.glabalDialog_container}>
        <div className={styles.glabalDialog_container_inner}>
          ...
          <div className={styles.button_list}>
            <div className={styles.button_confirm} onClick={handleLeft} onMouseEnter={playSeEnter}>
              {props.leftText}
            </div>
            <div className={styles.button_cancel} onClick={handleRight} onMouseEnter={playSeEnter}>
              {props.rightText}
            </div>
          </div>
        </div>
