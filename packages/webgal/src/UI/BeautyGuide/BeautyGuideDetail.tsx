...
const BeautyGuideDetail: FC<IProps> = (props: IProps) => {
  ...
  useEffect(() => {
    ...
    if (infoData?.contentList && infoData?.contentList?.length > 0) {
      ...
      const style =
        collectionUIConfigs.other[CollectionSceneOtherKey.Collection_detail_right_thumbnail_bg]?.args?.style ?? {};
      // 缩略图占位 thumbnailItem
      ...
      <div className={styles.beautyGuideDetail_main}>
        ...
        <div className={styles.beautyGuideDetail_left}>
          <div
            ...
            style={parseStyleArg(
              collectionUIConfigs.other[CollectionSceneOtherKey.Collection_detail_left_bg]?.args?.style,
            )}
          >
            <BgImage
        ...
        <div className={styles.beautyGuideDetail_right}>
          ...
          <div
            ...
            style={{
              display: collectionUIConfigs.other[CollectionSceneOtherKey.Collection_detail_right_content_bg]?.args?.hide
                ? 'none'
                : 'block',
            }}
          >
            <div
              ...
              className={`${styles.content} 
                ${
                  collectionUIConfigs.other[CollectionSceneOtherKey.Collection_detail_right_content_bg]?.args?.style
                    .image
                    ? styles.hideBgc
                    : ''
                }`}
                ...
                {thumbnailData?.map((item: contentListItem, index: number) => {
                  return (
                    <div
                      ...
                      style={parseStyleArg(
                        collectionUIConfigs.other[CollectionSceneOtherKey.Collection_detail_right_thumbnail_bg]?.args
                          ?.style,
                      )}
                      onClick={() => {
